        ...
        <nav class="navbar navbar-inverse navbar-static-top example6">
            <div class="container">
              <div class="navbar-header">
                ...
                <a class="navbar-brand " href="{{URL::to('frontend/images/home/logo2.png')}}">
                </a>
              </div>
              <div id="navbar6" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                  <li><a href="#">+91-012-345-6789</a></li>
                  <li><a href="#">ink-kart@gmail.com</a></li>
                </ul>
              </div>
              <!--/.nav-collapse -->
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/home')}}"><img src="{{URL::to('frontend/images/home/logo2.png')}}" alt="" /></a>
                        </div>
                     ...
                     <?php if($customer_id != NULL){?>
                      ...
                      <?php  }else{?>
                        ...
                        <?php } ?>
                                ...
                                <li><a href="404.html">Offers</a></li>
 ...
 @yield('slider');
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2019 INK-KART Inc. All rights reserved.</p>
                    <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">INK_KART</a></span></p>
                </div>
            </div>
        </div>
